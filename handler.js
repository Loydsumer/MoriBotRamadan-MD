...
this.sendMessage(m.chat, {text: `🐈 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀 𝙂𝘼𝙏𝘼𝘾𝙊𝙄𝙉𝙎`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' Ramadan Mubarak ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
			
m.exp += xp
if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝐌𝐨𝐫𝐢 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
//this.reply(m.chat, `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`, m)
continue //Sin límite
}
if (plugin.level > _user.level) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont9']()} *${plugin.level}* ${lenguajeGB['smsCont10']()} *${_user.level}* ${lenguajeGB['smsCont11']()} *${usedPrefix}nivel*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𝐌𝐨𝐫𝐢', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
...
if (db.data.chats[m.chat].reaction && m.text.match(/(بوت|موري)/gi)) {
...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '𝐌𝐨𝐫𝐢') :
...
"thumbnail": apii.data, 
"title": [wm, '𝐌𝐨𝐫𝐢 ' + gt + ' 📍', 'Ramadan Kareem 💓'].getRandom(),
"containsAutoReply": true,
"mediaType": 1, 
sourceUrl: 'https://whatsapp.com/channel/0029Vb0WYOu2f3EAb74gf02h' }}}, { quoted: fkontak2 })
apii.data = ''
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: ['𒆜 𝐌𝐨𝐫𝐢 𝐁𝐨𝐭 𒆜'], body: [wm, '𝐌𝐨𝐫𝐢 ' + gt + ' 📍', 'Ramadan Kareem'].getRandom(), thumbnail: gataImg, sourceUrl: accountsgb }}}}, tg)
