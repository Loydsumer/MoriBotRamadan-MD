...
┊${chalk.blueBright('┊')}${chalk.cyan(`😺 MY TELEGRAM: ${packageJsonObj.author.name} (@Q1_1R)`)}
┊${chalk.blueBright('┊')}${chalk.blueBright('┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅')} 
┊${chalk.blueBright('┊')}${chalk.yellow(`💜 Developers:`)}
┊${chalk.blueBright('┊')}${chalk.yellow(`• Mori (Omar Mohamed)`)}
┊${chalk.blueBright('╰┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅')} 
┊${chalk.blueBright('╭┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅')}
