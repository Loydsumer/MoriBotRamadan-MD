...
let canalId = ["120363361446297518@newsletter", "120363361446297518@newsletter", "120363361446297518@newsletter", "120363361446297518@newsletter", " 120363361446297518@newsletter", "120363361446297518@newsletter"]
let canalNombre = ["ٕ𒆜 𝐌𝐨𝐫𝐢 𝐔𝐩𝐝𝐚𝐭𝐞 𒆜", "ٕ𒆜 𝐌𝐨𝐫𝐢 𝐔𝐩𝐝𝐚𝐭𝐞 𒆜", "ٕ𒆜 𝐌𝐨𝐫𝐢 𝐔𝐩𝐝𝐚𝐭𝐞 𒆜", "ٕ𒆜 𝐌𝐨𝐫𝐢 𝐔𝐩𝐝𝐚𝐭𝐞 𒆜", "ٕ𒆜 𝐌𝐨𝐫𝐢 𝐔𝐩𝐝𝐚𝐭𝐞 𒆜", 'ٕ𒆜 𝐌𝐨𝐫𝐢 𝐔𝐩𝐝𝐚𝐭𝐞 𒆜']
    ...
    conn.sendMessage(jid, { video: gif, gifPlayback: true, gifAttribution: b, caption: text, footer: footer, jpegThumbnail: file, templateButtons: but, ...options })
        ...
        parseMention: {
		 ...
		 const matches = text.match(/@([0-9]{5,16}|0)/g)
                 return matches ? matches.map(v => v.slice(1) + '@s.whatsapp.net') : []
            },
            enumerable: true
        },
getName: {
