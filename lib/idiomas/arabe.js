...
const smsAvisoAG = () => { return `╰⊱⚠️⊱ تــنــبــيــه قــضــائــي ⊱⚠️⊱╮\n\n` }
...
const smsPrivate = () => { return `\`\`\`¡¡لا يمكن استخدام هذا الأمر إلا في الخاص!!\`\`\`` }
...
const smsRestrict = () => { return `\`\`\`¡¡هذا الأمر مقيد من قِبل مطوري!!\`\`\`` }
