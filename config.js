...
global.owner = [
["201159106301", '👑 Mori 👑', true], //𝙂𝙖𝙩𝙖𝘽𝙤𝙩-𝙈𝘿 💖🐈
]
...
["201159106301", '👑 Ramadan - Mori 👑', 1], 
["201159106301", '👑 Ramadan - Mori 👑', 1],  
["201159106301", '👑 Ramadan - Mori 👑', 1]]

global.mail = 'yto941395@gmail.com' // Add email
...
global.packname = `Mori﹝🌙﹞Bot` //"𝙂𝙖𝙩𝙖𝘽𝙤𝙩-𝙈𝘿 🐈"
global.author = `By Mori 2025` //"𝙂𝙖𝙩𝙖 𝘿𝙞𝙤𝙨"
...
let emot = {
      ...
      keygold: '🔑 مـفـتـاح ذهــبــي',
      keyiron: '🗝️ مــفــتــاح حــديــد',
      emas: lenguajeGB.ePinata(),
      fishingrod: '🎣 ســنــارة صــيــد',
      gems: '🍀 الــعــاب',
      magicwand: '⚕️ الــعــصــا الــســحــريــة',
      mana: '🪄 الــمــانــا',
      agility: '🤸‍♂️ خــفــة الــحــركــة',
      darkcrystal: '♠️ كــريــســتــال داكــن',
      iron: lenguajeGB.eHierro(),
      rock: lenguajeGB.eRoca(),
      potion: lenguajeGB.ePocion(),
      superior: '💼 تــرقــيــة',
      robo: '🚔 ســرقــة',
      upgrader: '🧰 عميل',
...
string = string.toLowerCase();
let emott = {
      مستوي: '🧬', جوهرة: '💎', خبرة: '💷', بنك: '🏦',
      جواهر: '💎+', دماء: '❤️', كيوبي: '🌀', joincount: '🪙',
      الزمرد: '💚', قوة: '✨', الرتبة: '🎗', بريميم: '🎟️',
      XP: '📧', ذهب: '👑',
      ...
      horse: '🐎', kambing: '🐐', kerbau: '🐃', اسد: '🦁', money: '🐱', monyet: '🐒', panda: '🐼',
...
string = string.toLowerCase();
let emottt = {
      خبرة: lenguajeGB.eExp(), limit: lenguajeGB.eDiamante(), جواهر: lenguajeGB.eDiamantePlus(), joincount: lenguajeGB.eToken(),
      emerald: lenguajeGB.eEsmeralda(), berlian: lenguajeGB.eJoya(), kyubi: lenguajeGB.eMagia(), ذهب: lenguajeGB.eOro(),
      نقود: lenguajeGB.eGataCoins(), tiketcoin: lenguajeGB.eGataTickers(), stamina: lenguajeGB.eEnergia(),
...
string = string.toLowerCase();
let emotttt = {
      خبرة: '💷', limit: '💎', diamond: '💎+', joincount: '🪙',
      emerald: '💚', berlian: '♦️', kyubi: '🌀', ذهب: '👑',
      نقود: '🐱', tiketcoin: '🎫', stamina: '✨',
...
const response = await fetch('https://raw.githubusercontent.com/araab-zack/ROLLO-BOT/refs/heads/master/official_accounts.json')
