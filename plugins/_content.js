...
global.canales = [canal1, canal2, canal3].getRandom()
global.welgata = [tk, ig, yt2, yt2, ig, md, ig, yt, paypal, yt2, yt2, ig, fb, tk, ths, asistencia].getRandom()
global.redesMenu = [canal1, canal2, canal3, soporteGB, grupo1, grupo2, grupo3, md, ig, paypal, yt, asistencia, fb, tk].getRandom()
global.accountsgb = [canal1, canal2, canal3, tk, ig, yt, paypal, fb, ths, md, asistencia].getRandom()

global.canalIdGB = ["120363373852773234@newsletter", "120363373852773234@newsletter", "120363373852773234@newsletter", "120363373852773234@newsletter"]
global.canalNombreGB = ["𒆜 𝐌𝐨𝐫𝐢 𝐁𝐨𝐭 𒆜", "𒆜 𝐌𝐨𝐫𝐢 𝐁𝐨𝐭 𒆜", "𒆜 𝐌𝐨𝐫𝐢 𝐁𝐨𝐭 𒆜", "𝐑𝐀𝐈𝐙𝐄𝐋﹝🦇﹞𝐔𝐏𝐃𝐀𝐓𝐄"]
...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '【🦇┇𝐑𝐀𝐈𝐙𝐄𝐋 𝐁𝐎𝐓┇🦇 】', thumbnailUrl: gataMenu, sourceUrl: accountsgb }}}
